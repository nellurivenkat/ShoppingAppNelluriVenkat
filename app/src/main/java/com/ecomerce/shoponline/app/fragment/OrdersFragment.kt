...
import com.ecomerce.shoponline.app.adapter.OrderAdapter
...
class OrdersFragment : Fragment() {
    ...
    override fun onCreateView(
      ...
      val view= inflater.inflate(R.layout.fragment_orders, container, false)
        recyclerView=view.findViewById(R.id.order_frag_rex)
        ...
        if(sharedPreferences.getString("orderItems","")?.isNotEmpty() == true) {
            ...
            val adapter = OrderAdapter(requireContext(), dataList)
